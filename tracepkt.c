...
struct route_evt_t {
  ...
  u64 icmptype;
  u64 icmpid; // In practice, this is the PID of the ping process (see "ident"
              // field in
              // https://github.com/iputils/iputils/blob/s20161105/ping_common.c
              // WARN: latest version of ping has changed.
...
static inline int do_trace_skb(struct route_evt_t *evt, void *ctx,
  ...
  // Filter ICMP packets at IP Layer
